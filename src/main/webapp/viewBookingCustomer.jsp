...
<div class="header">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-8">
        <h1 class="header-title"><i class="fas fa-calendar-alt me-2"></i>View Bookings</h1>
        <p class="header-subtitle">View all hotel reservations</p>
      </div>
      <div class="col-md-4 text-end">
        <a href="index.jsp" class="btn btn-light">
          <i class="fas fa-arrow-left me-2"></i>Back to Search Page
        </a>
      </div>
    </div>
  </div>
...
<div class="container">
    ...
    <div class="card-body">
      <div class="table-responsive">
        <table>
          ...
          <tbody>
          <%
            String sql = "SELECT * FROM public.booking WHERE customerID = ?";
            String customerID = request.getParameter("customerID");

            ConnectionDB db = new ConnectionDB();
            try (Connection con = db.getConnection()) {
              PreparedStatement stmt = con.prepareStatement(sql);
              stmt.setInt(1, Integer.valueOf(customerID));
  ...
  <div class="text-center mt-4 mb-5">
    <a href="index.jsp" class="btn btn-dashboard">
      <i class="fas fa-tachometer-alt me-2"></i>Return to Search Page
    </a>
  </div>
</div>
